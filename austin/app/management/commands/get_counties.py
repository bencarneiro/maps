...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        new_county = County(
            id = 2220,
            state_id = 2,
            name = "Sitka, City and Borough of"
        )
        new_county.save()
        ...
        new_county = County(
            id = 2275,
            state_id = 2,
            name = "Wrangell, City and Borough of"
        )
        new_county.save()
        ...
        new_county = County(
            id = 2282,
            state_id = 2,
            name = "Yakutat, City and Borough of"
        )
        new_county.save()
